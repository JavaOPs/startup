...
- **Виртуальный выделенный сервер** - дешевый, с полным доступом к администрированию по ssh и с публичным IP для доступа.  
  Если планируется только одно небольшое приложение - можно выбирать самый недорогой тариф: **RAM 1G, SSD от 10Gb, публичный IP**.
    ...
    - [MakeCloud](https://makecloud.ru/), [RUVDS](https://ruvds.com/ru-rub/pricing#order), [HOSTING RUSSIA](https://hosting-russia.ru/tariffs), [VPSdedic](https://vpsdedic.ru/vpsserver.html), [Timeweb](https://timeweb.com/ru/services/vds/), [Джино](https://jino.ru/vps/), [VpsVille](https://vpsville.ru/vds-vps-hosting/), [Hostkey](https://hostkey.ru/vps/), [beGet](https://beget.com/ru/vps)
